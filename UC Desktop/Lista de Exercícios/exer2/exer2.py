...
# Form implementation generated from reading ui file 'exer2.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(200, 30, 411, 21))
        font = QtGui.QFont()
        ...
        self.lineEdit_num.setGeometry(QtCore.QRect(380, 130, 113, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lineEdit_num.setFont(font)
        self.lineEdit_num.setObjectName("lineEdit_num")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(280, 130, 91, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.pushButton_calcular = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_calcular.setGeometry(QtCore.QRect(360, 180, 75, 23))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_resultado.setGeometry(QtCore.QRect(160, 340, 521, 61))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Soma dos Primeiros Números Naturais"))
